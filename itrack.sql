...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2018 at 07:32 AM
...
INSERT INTO `effects` (`effects_id`, `effects_name`, `effects_hours`) VALUES
(1, 'dusap', 100),
(2, 'suspension', 0);
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `fk_dussap_incident_report_id` FOREIGN KEY (`incident_report_id`) REFERENCES `incident_report` (`incident_report_id`);
