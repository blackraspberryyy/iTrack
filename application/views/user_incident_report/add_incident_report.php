                        ...
                        <form action="<?= base_url(); ?>UserIncidentReport/add_incident_report_exec/<?= $user->user_number; ?>" method="POST" autocomplete="off">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" formaction="<?= base_url(); ?>UserIncidentReport/add_incident_report_exec_no_userID/<?= $user->user_number; ?>" class="btn btn-success">Submit w/o User Id</button>
                                </div>
                            </div>
                        </form>
                    </div>
