            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse"><span class="sr-only">Toggle navigation</span>
                        ...
                        <a class="navbar-brand" href="<?= base_url()?>studentdashboard"><img src = "<?= base_url()?>images/logo.png"></a>
                </div>
            </div><!-- /.container-fluid -->
        </nav>
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            <div class="profile-sidebar">
                <div class="profile-userpic">
                    <img src="<?= base_url().$currentstudent->student_picture?>" class="img-responsive" alt="">
                </div>
                <div class="profile-usertitle">
                    <div class="profile-usertitle-name"><?= $currentstudent->student_lastname?>, <?= $currentstudent->student_firstname?></div>
                    <div class="profile-usertitle-status"><?= $currentstudent->student_number?></div>
                </div>
                <div class="clear"></div>
            </div>
            <div class="divider"></div>
            <ul class="nav menu">
                <li class="<?= strpos(base_url(uri_string()), $this->config->base_url() . "studentdashboard") !== FALSE ? "active" : ""; ?>"><a href="<?= base_url()?>studentdashboard"><em class="fa fa-home">&nbsp;</em> Home</a></li>
                <li class="<?= strpos(base_url(uri_string()), $this->config->base_url() . "studentprofile") !== FALSE ? "active" : ""; ?>"><a href="<?= base_url()?>studentprofile"><em class="fa fa-user">&nbsp;</em> Student Profile</a></li>
                <li class="<?= strpos(base_url(uri_string()), $this->config->base_url() . "studentviolation") !== FALSE ? "active" : ""; ?>"><a href="<?= base_url()?>studentviolation"><em class="fa fa-exclamation-triangle">&nbsp;</em> Student Violation</a></li>
                <li class="<?= strpos(base_url(uri_string()), $this->config->base_url() . "studentincidentreport") !== FALSE ? "active" : ""; ?>"><a href="<?= base_url()?>studentincidentreport"><em class="fa fa-newspaper">&nbsp;</em> Incident Report</a></li>
                <li class="parent">
                ...
                <li class="<?= strpos(base_url(uri_string()), $this->config->base_url() . "studentoffensereport") !== FALSE ? "active" : ""; ?>"><a href="<?= base_url()?>studentoffensereport"><em class="fa fa-exclamation-circle">&nbsp;</em> Offense Report</a></li>
                ...
                <li class="<?= strpos(base_url(uri_string()), $this->config->base_url() . "studentnotification") !== FALSE ? "active" : ""; ?>"><a href="<?=  base_url()?>studentnotification"><em class="fa fa-bell">&nbsp;</em> Notifications</a></li>
                <li class="<?= strpos(base_url(uri_string()), $this->config->base_url() . "studentfaq") !== FALSE ? "active" : ""; ?>"><a href="<?=  base_url()?>studentfaq"><em class="fa fa-lightbulb">&nbsp;</em> FAQ</a></li>
