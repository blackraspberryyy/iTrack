    ...
    <?php include 'preloader.php' ?>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="<?= (strpos(base_url(uri_string()), $this->config->base_url() . "adminincidentreport") !== FALSE) || (strpos(base_url(uri_string()), $this->config->base_url() . "admindussap") !== FALSE)? "active" : ""; ?>"><a href="<?= base_url() ?>adminincidentreport"><em class="fa fa-newspaper">&nbsp;</em> Incident Reports</a></li>
