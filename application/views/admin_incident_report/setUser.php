...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url() ?>AdminIncidentReport">Incident Reports</a></li>
...
<div class = "row">
		<br/>
    <form action="<?= base_url()?>AdminIncidentReport/setUser_submit/<?= $incident_report[0]->incident_report_id?>" method="POST">
      <div class = "col-md-12">
        ...
        <div class="row">
          <br/><br/>
          <center>
            <a href="<?= base_url()?>AdminIncidentReport" type="button" class="btn btn-secondary">Cancel</a>
